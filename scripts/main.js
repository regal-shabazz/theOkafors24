      ...
      <section id="rsvp-page">
        ...
        <h2 id="hero-bg"></h2>
          ...
          <div class="rsvp-query">
            ...
            <button id="submit-code" disabled>YES! I'll be attending!</button>
          </div>
            ...
            <div id="rsvp-response">
              <button id="accept-button" disabled>Joyfully Accept!</button>     
            </div>
          </div>
        </div>
      </section>
  ...
  function handleSplashScreenTransitionToHomepage() {
    setTimeout(() => {
      ...
      acceptButton.addEventListener("click", () => {
        createModal("accept-modal", "accept-form", "Event: Cocktail Hour and Dinner", handleAcceptSubmit);
      });
    ...
    modal.innerHTML = `
      <div class="modal-content">
        ...
        <div class="donation-details">
          ...
          <p>For gifting, kindly click <a style="font-style: italic; color: #f56e6e; margin-bottom: 20px" href="./pages/proofofpayment.html" target="_blank">Here</a>.</p>
